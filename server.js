...
//get collection name
//look up what app.param does - sets req.Collection to be the collectionName passed as the parameter through the request. 
...
app.get('/collection/users/:email', (req, res, next) => {
